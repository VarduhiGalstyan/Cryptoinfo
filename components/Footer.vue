...
let infoHeader = api.myHeader?.info_header_en || '';
let contact_email = api.myHeader?.contact_email || '';
let footerText = locale.value === 'ru' ? api.myHeader?.info_footer_ru : api.myHeader?.info_footer_en || '';
let logo = api.myHeader?.logo || '';
